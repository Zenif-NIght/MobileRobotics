classdef CombinedGoToGoalVectorScenario < VectorFieldScenario
    ...
    methods
        function obj = CombinedGoToGoalVectorScenario(veh, control_type)
            % Plotting variables
            x_vec = -1:1:20;
            y_vec = -6:1:10;
            ...
            S = 1; % Sphere of influence % try 3
            R = 0.5; % Radius of max influence % try 2
            ...
            for k = avoid_indices
                fields{k} = AvoidObstacle(x_vec, y_vec, q_inf, v_max);
                fields{k}.S = S;
                fields{k}.R = R;
            end

classdef SwithingLineScenarioObstacleAvoidBetterSwitch < VectorFieldScenario
    ...
    methods
        ...
        function new_goal = switchingFunction(obj, t, x)
            %%% TODO: update the switching function
        ...
        function updateHalfPlane(obj, goal, psi)
            ...
            %%% TODO: fine a point, v2, that is one a line with v1 where
            %%% that line is orthogonal to the line being followed
            v2 = ???;
        ...
        function [a, b, c] = createHalfPlane(obj, v1, v2)
            %%% TODO: Create a half plane from the two points            
            a = obj.a;
            b = obj.b;
            c = obj.c;
        end
